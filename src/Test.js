...
const Test = () => {
  ...
  const countrydatass =
    ...
    countryID === getProfileDetails?.data?.CountryName
     ...
     const citydatass = countryID === undefined ||
     countryID === getProfileDetails?.data?.CountryName
                                  ...
                                  >
                                    ...
                                    countryID ===
                                      ...
                                      <option value="">
                                        ...
                                        {/* { countryID === undefined || stateeID === undefined || stateeID === getProfileDetails?.data?.StateName ?  values?.stateName : " "} */}
                                        {/* {countryID === undefined || getProfileDetails?.data?.CountryName || stateeID === undefined ?  values?.stateName : " "} */}
                                      </option>
                                    ) : (
